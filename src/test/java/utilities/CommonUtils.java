...
public class CommonUtils {
    ...
    public void switchToWindow() {
        ...
        Iterator<String> iterator = windowhadles.iterator();
        String currentWindowHandle = driver.getWindowHandle();
        while (iterator.hasNext()) {
            String newHandle = iterator.next();
            if (!iterator.next().equalsIgnoreCase(currentWindowHandle)) {
        ...
        public static String getProperty (String key){
            try {
                ...
                Properties properties = readPropertyFile("/Users/nargizatalipova/Downloads/Cocumber/src/test/resources/Config/Configurations.properties");
